...
const HomeReviews = (props: React.HTMLAttributes<HTMLElement>) => {
    return (
        <section id={props.id} className={`${props.className} px-2.5 desktop:px-10 mt-20 w-full flex flex-col gap-10 items-center relative desktop:mt-50`}>
            ...
            <ul className="desktop:hidden flex flex-row gap-2.5 pl-2 overflow-x-scroll scrollbar-hidden overflow-y-hidden max-w-mobile mobile:max-w-[clamp(360px,100vw,1280px)] w-full self-start justify-start z-30 pb-48">
            ...
            <ul className="hidden desktop:grid grid-cols-17 grid-rows-12 gap-5 pl-2 w-full z-20 pb-48">
